    ...
    export default {
        ...
        methods: {
            renderGraph(data) {
                ...
                let rightArc = d3.svg.arc().outerRadius(60).innerRadius(30).startAngle(0).endAngle(1.88);
                let leftArc = d3.svg.arc().outerRadius(60).innerRadius(30).startAngle(4.5).endAngle(6.26);
                let bottomArc = d3.svg.arc().outerRadius(60).innerRadius(30).startAngle(1.9).endAngle(4.48);
                ...
                function circleClick(node, i, _this) {
                    ...
                    console.log(existedRing,'existedRing')
